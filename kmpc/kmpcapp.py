    ...
    def __call__(self, result):
        ...
        for s in result:
            ...
            if format(s) == 'playlist':
                ...
                mainmpdconnection.protocol.status().addCallback(app.root.update_mpd_status).addErrback(app.root.handle_mpd_error)
                ...
                mainmpdconnection.protocol.readmessages().addCallback(app.root.handle_mpd_message).addErrback(app.root.handle_mpd_error)
            else:
